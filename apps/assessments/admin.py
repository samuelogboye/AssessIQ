...
class ExamAdmin(admin.ModelAdmin):
    ...
    list_display = ['title', 'course', 'status', 'duration_minutes', 'total_marks', 'start_time', 'end_time', 'created_at']
...
class QuestionAdmin(admin.ModelAdmin):
    ...
    list_display = ['exam', 'question_number', 'question_type', 'marks', 'use_ai_grading', 'created_at']
    ...
    fieldsets = (
        (None, {
            'fields': ('exam', 'question_number', 'question_type', 'question_text', 'marks')
        }),
        (_('Options & Answers'), {
            'fields': ('options', 'correct_answer', 'acceptable_answers')
        }),
